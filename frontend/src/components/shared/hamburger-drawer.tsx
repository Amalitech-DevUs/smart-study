...
export function HamburgerDrawer() {
  ...
  const navLinks = loggedIn
    ? [
        ...
        { label: "Revision Guides", href: "/articles", icon: FileText },
  ...
  return (
    <>
      ...
      <button
        ...
        className="relative flex h-9 w-9 items-center justify-center rounded-xl border border-slate-700/80 bg-slate-800/80 text-white transition-all hover:bg-slate-700 hover:border-slate-600 active:scale-95 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-400"
      ...
      >
        ...
        <div className="flex h-3.5 w-4 flex-col justify-between">
          <span
            className={`block h-[1.75px] w-full rounded-full bg-white transition-all duration-200 ease-out origin-center ${
                ...
                {loggedIn ? (
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <Link
                      href="/signup"
                      onClick={() => setIsOpen(false)}
                      className="flex items-center justify-center rounded-xl bg-amber-400 py-2 text-center text-xs font-bold text-slate-950 transition-colors hover:bg-amber-300 shadow-xs"
                    >
                      Sign up
                    </Link>
                  </div>
